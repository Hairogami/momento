...
function SearchMockup() {
  return (
    <div className="clone-mockup rounded-2xl overflow-hidden" style={{ background: "rgba(183,191,217,0.07)", border: "1px solid rgba(183,191,217,0.2)", padding: 20 }}>
      {/* Search bar */}
      <div className="clone-mockup-surface flex items-center gap-2 mb-4 px-3 py-2.5 rounded-xl" style={{ background: "#fff", border: "1px solid rgba(183,191,217,0.3)" }}>
        <GsIcon icon="search" size={16} />
        <span className="clone-mockup-muted" style={{ fontSize: 12, color: "#9a9aaa" }}>Photographe mariage Casablanca...</span>
        <span className="ml-auto px-2 py-0.5 rounded-full text-xs clone-mockup-muted" style={{ background: "rgba(183,191,217,0.18)", color: "#6a6a71" }}>Filtrer</span>
      </div>
      {/* Category chips */}
      ...
      {[
        ...
        <div key={i} className="clone-mockup-surface flex items-center gap-3 p-3 rounded-xl mb-2" style={{ background: "rgba(255,255,255,0.85)", border: "1px solid rgba(183,191,217,0.18)" }}>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1">
              <span className="clone-mockup-text-h" style={{ fontSize: 12, fontWeight: 600, color: "#121317" }}>{v.name}</span>
              <GsIcon icon="verified" size={12} className="text-rose-600" />
            </div>
            <div className="clone-mockup-muted" style={{ fontSize: 11, color: "#6a6a71" }}>{v.cat} · {v.city}</div>
          </div>
          <div className="text-right flex-shrink-0">
            <div style={{ fontSize: 11, fontWeight: 600, color: "#F59E0B" }}>★ {v.rating}</div>
            <div className="clone-mockup-muted" style={{ fontSize: 10, color: "#9a9aaa" }}>{v.price}</div>
          </div>
        </div>
      ))}
    </div>
      ...
      <div className="flex items-start gap-4 mb-5">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 flex-wrap mb-1">
            <span className="clone-mockup-text-h" style={{ fontSize: 15, fontWeight: 700, color: "#121317" }}>Anissa Photography</span>
          ...
          <div className="clone-mockup-muted" style={{ fontSize: 12, color: "#6a6a71" }}>Photographe · Casablanca, Rabat</div>
          <div className="flex items-center gap-1 mt-1.5">
            <span style={{ fontSize: 13, color: "#F59E0B" }}>★★★★★</span>
            <span className="clone-mockup-muted" style={{ fontSize: 12, color: "#6a6a71", marginLeft: 4 }}>4.9 · 47 avis</span>
          </div>
        </div>
      </div>
      <div className="clone-mockup-muted" style={{ fontSize: 11, color: "#6a6a71", marginBottom: 10, fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase" }}>Avis clients</div>
      {[
        ...
        <div key={i} className="clone-mockup-surface p-3 rounded-xl mb-2" style={{ background: "rgba(255,255,255,0.8)", border: "1px solid rgba(183,191,217,0.18)" }}>
          <div className="flex items-center gap-2 mb-1">
            <span className="clone-mockup-text-h" style={{ fontSize: 12, fontWeight: 600, color: "#121317" }}>{r.author}</span>
            <span style={{ fontSize: 11, color: "#F59E0B" }}>★★★★★</span>
          </div>
          <span className="clone-mockup-text" style={{ fontSize: 12, color: "#6a6a71" }}>{r.text}</span>
        </div>
      ))}
    </div>
  )
...
function BookingMockup() {
  return (
    <div className="clone-mockup rounded-2xl overflow-hidden" style={{ background: "rgba(183,191,217,0.07)", border: "1px solid rgba(183,191,217,0.2)" }}>
      {/* Vendor header */}
      <div className="clone-mockup-surface flex items-center gap-3 p-4" style={{ borderBottom: "1px solid rgba(183,191,217,0.15)", background: "rgba(255,255,255,0.65)" }}>
        ...
        <div className="flex-1">
          <div className="clone-mockup-text-h" style={{ fontSize: 13, fontWeight: 600, color: "#121317" }}>Karim Benali</div>
          <div className="flex items-center gap-1">
      ...
      <div className="px-4 pt-4 pb-2">
        <div className="clone-mockup-surface p-3 rounded-xl mb-3" style={{ background: "rgba(99,102,241,0.07)", border: "1px solid rgba(99,102,241,0.15)" }}>
          <div className="clone-mockup-muted" style={{ fontSize: 10, color: "#6a6a71", marginBottom: 6, fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase" }}>Devis reçu</div>
          <div className="flex items-center justify-between">
            <div>
              <div className="clone-mockup-text-h" style={{ fontSize: 13, fontWeight: 700, color: "#121317" }}>Package Mariage Complet</div>
              <div className="clone-mockup-muted" style={{ fontSize: 11, color: "#6a6a71" }}>8h · 2 photographes · retouches incluses</div>
            </div>
            <div style={{ fontSize: 15, fontWeight: 800, color: "#121317" }}>4 500 MAD</div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2 mb-3">
          ...
          <div className="flex justify-start">
            <div className="clone-mockup-surface px-3 py-2 rounded-2xl rounded-tl-sm" style={{ background: "rgba(255,255,255,0.9)", border: "1px solid rgba(183,191,217,0.22)", fontSize: 12, color: "#121317", maxWidth: "80%" }}>
      ...
      <div className="p-4 pt-2">
        <div className="clone-mockup-surface flex items-center gap-2 px-3 py-2.5 rounded-full" style={{ background: "rgba(255,255,255,0.8)", border: "1px solid rgba(183,191,217,0.28)" }}>
          <span className="clone-mockup-muted" style={{ fontSize: 12, color: "#9a9aaa", flex: 1 }}>Envoyer un message...</span>
  ...
  return (
    <div className="clone-mockup rounded-2xl" style={{ background: "rgba(183,191,217,0.07)", border: "1px solid rgba(183,191,217,0.2)", padding: 24 }}>
      <div className="flex items-center justify-between mb-5">
        <div>
          <div className="clone-mockup-text-h" style={{ fontSize: 14, fontWeight: 700, color: "#121317" }}>Mariage Yasmine & Ali</div>
          <div className="clone-mockup-muted" style={{ fontSize: 12, color: "#6a6a71", marginTop: 2 }}>15 juin 2025 · Casablanca · 87 invités</div>
        </div>
      ...
      <div className="mb-5">
        <div className="flex justify-between mb-1.5">
          <span className="clone-mockup-muted" style={{ fontSize: 11, color: "#6a6a71" }}>Budget utilisé</span>
      ...
      {[
        ...
        <div key={i} className="flex items-start gap-3 mb-2.5">
          ...
          <div>
            ...
            <div className="clone-mockup-muted" style={{ fontSize: 10, color: "#6a6a71" }}>{t.sub}</div>
          </div>
        </div>
      ))}
    </div>
          ...
          <div className="lg:sticky top-24 self-start py-16 lg:py-32">
            <div className="flex flex-col gap-4 transition-all duration-500" key={active}>
              ...
              <h3 className="clone-heading"
                style={{ fontSize: "clamp(1.8rem, 3.5vw, 3rem)", fontWeight: 600, lineHeight: 1.1, letterSpacing: "-0.02em", color: "#121317" }}
              >
                {f.title}
              </h3>
              <p className="clone-body" style={{ fontSize: 15, lineHeight: 1.7, color: "#6a6a71", maxWidth: 420 }}>
                {f.desc}
              </p>
            ...
            <a
              ...
              style={{ background: "rgba(183,191,217,0.12)", color: "#121317", border: "1px solid rgba(183,191,217,0.25)" }}
            >
