...
export const metadata = {
  ...
  description: "Découvrez 1000+ prestataires événementiels vérifiés au Maroc. Photographes, DJ, traiteurs, neggafa, décorateurs, wedding planners — 41 villes, 0% commission.",
}
