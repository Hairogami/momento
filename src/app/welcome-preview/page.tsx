      ...
      <div style={{ width: "100%", maxWidth: 520 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <Link href="/" style={{ display: "inline-flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
            ...
            <span style={{ fontSize: "var(--text-md)", fontWeight: 700, color: "#121317", letterSpacing: "-0.01em" }}>Momento</span>
          </Link>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            color: "#E11D48", fontSize: "var(--text-xs)", fontWeight: 700,
          ...
          <h1 style={{
            fontSize: "var(--text-xl)", fontWeight: 700, color: "#121317",
          ...
          <p style={{
            fontSize: "var(--text-base)", color: "#6a6a71",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <label style={{
              ...
              <div>
                <div style={{ fontSize: "var(--text-sm)", fontWeight: 600, color: "#121317", marginBottom: 4 }}>
                  J&apos;accepte les conditions <span style={{ color: "#E11D48" }}>*</span>
                </div>
                <div style={{ fontSize: "var(--text-sm)", color: "#6a6a71", lineHeight: 1.5 }}>
            ...
            <label style={{
              ...
              <div>
                <div style={{ fontSize: "var(--text-sm)", fontWeight: 600, color: "#121317", marginBottom: 4 }}>
                  Conseils &amp; offres Momento <span style={{ fontSize: "var(--text-xs)", fontWeight: 500, color: "#9a9aaa", marginLeft: 4 }}>facultatif</span>
                </div>
                <div style={{ fontSize: "var(--text-sm)", color: "#6a6a71", lineHeight: 1.5 }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: "var(--text-xs)", color: "#4a5a4a", margin: 0, lineHeight: 1.55 }}>
          ...
          {/* Logout escape */}
          <p style={{
            fontSize: "var(--text-xs)", color: "#9a9aaa", textAlign: "center",
        ...
        <div style={{
          ...
          fontSize: "var(--text-xs)", color: "#c0c0ca", letterSpacing: "0.03em",
        }}>
