  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--dash-bg, #0d0e14)", color: "var(--dash-text, #eeeef5)", fontFamily: "'Geist', sans-serif", padding: "48px 24px" }}>
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        <h1 style={{ fontSize: 22, fontWeight: 800, margin: "0 0 6px" }}>Dev Panel</h1>
        <p style={{ fontSize: 13, color: "var(--dash-text-2, #b0b0cc)", margin: "0 0 36px" }}>
        ...
        <div style={{ background: "var(--dash-surface, #16171e)", borderRadius: 16, padding: "24px 28px", border: "1px solid var(--dash-border, rgba(255,255,255,0.07))" }}>
          <div style={{ fontSize: 11, letterSpacing: 1.4, textTransform: "uppercase", color: "var(--dash-text-3, #8888aa)", fontWeight: 700, marginBottom: 8 }}>Plan utilisateur courant</div>
          <div style={{ fontSize: 28, fontWeight: 800, backgroundImage: G, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 20 }}>
            <button
              ...
              style={{ flex: 1, padding: "13px", borderRadius: 12, border: plan === "free" ? "2px solid #22c55e" : "1.5px solid rgba(255,255,255,0.14)", background: plan === "free" ? "rgba(34,197,94,0.08)" : "transparent", color: "var(--dash-text, #eeeef5)", fontSize: 13, fontWeight: 700, cursor: saving || plan === "free" ? "default" : "pointer", fontFamily: "inherit" }}>
          ...
          {flash && (
            <div style={{ marginTop: 14, fontSize: 12, color: "#22c55e", fontWeight: 600 }}>{flash}</div>
          )}
        </div>

        <div style={{ marginTop: 24, fontSize: 12, color: "var(--dash-text-3, #8888aa)", lineHeight: 1.6 }}>
