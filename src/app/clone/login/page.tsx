      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          <Link href="/clone" style={{
            ...
            fontSize: 13, color: "#6a6a71", textDecoration: "none", marginBottom: 32,
          }}>
            ← Accueil
          </Link>

          <h2 style={{ fontSize: 24, fontWeight: 700, color: "#121317", margin: "0 0 6px", letterSpacing: "-0.02em" }}>
            Bon retour 👋
          </h2>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
            ...
            <form action={async () => { "use server"; await signIn("google", { redirectTo: "/accueil" }) }}>
              <button type="submit" style={{
                ...
                border: "1px solid rgba(183,191,217,0.4)", background: "#fff",
                display: "flex", alignItems: "center", justifyContent: "center", gap: 10,
                fontSize: 14, fontWeight: 500, color: "#121317", fontFamily: "inherit",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "20px 0" }}>
            ...
            <span style={{ fontSize: 12, color: "#9a9aaa" }}>ou</span>
            <div style={{ flex: 1, height: 1, background: "rgba(183,191,217,0.3)" }} />
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "20px 0" }}>
            <div style={{ flex: 1, height: 1, background: "rgba(183,191,217,0.3)" }} />
            <span style={{ fontSize: 12, color: "#9a9aaa" }}>lien magique</span>
            <div style={{ flex: 1, height: 1, background: "rgba(183,191,217,0.3)" }} />
          </div>
          ...
          <form action={async (fd: FormData) => {
            ...
            <button type="submit" style={{
              height: 46, borderRadius: 12, border: "1px solid rgba(183,191,217,0.3)",
              background: "transparent", color: "#6a6a71", fontSize: 13,
          ...
          <p style={{ fontSize: 12, color: "#9a9aaa", textAlign: "center", marginTop: 24 }}>
            En continuant, tu acceptes nos{" "}
            <a href="/legal/cgv" style={{ color: "#6a6a71" }}>conditions d&apos;utilisation</a>.
          </p>
        </div>
      </div>
    </div>
