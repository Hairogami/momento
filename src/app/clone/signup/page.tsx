...
export default function CloneSignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(false)
    if (res?.error) { setError("Compte créé ! Connectez-vous."); router.push("/clone/login") }
    ...
    <div className="ant-root" style={{
      ...
      <div style={{ width: "100%", maxWidth: 480 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <Link href="/clone" style={{ display: "inline-flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: "#9a9aaa", textAlign: "center", marginTop: 20 }}>
            Déjà un compte ?{" "}
            <Link href="/clone/login" style={{ color: "#E11D48", fontWeight: 600, textDecoration: "none" }}>
              Se connecter
            </Link>
          </p>
        </div>
